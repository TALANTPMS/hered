...
function showStartQuestions() {
    ...
    const questions = [
        'Расскажите о компании и подъемниках',
        'Меня интересует конкретный подъемник',
        'Хочу рассчитать условия лизинг или рассрочки',
        'Какие гарантии вы даете на подъемники?',
        'Какие подъемники есть в наличии?',
